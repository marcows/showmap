 ...
 * https://www.mapquest.com/?center=38.5,-97.99999999999999&zoom=5&maptype=map
 * https://kart.gulesider.no/?c=63,11.25&z=5
 */
function parseGeoURL_OSRM(uri)
{
	...
	zoom = decuri.match(/[?&](?:z|zoom|lvl)=([0-9]+)/);
	latlon = decuri.match(/[?&](?:center|cp|c)=(-?[0-9.]+)[,~](-?[0-9.]+)/);
